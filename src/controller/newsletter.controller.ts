...
import { NewsletterFilters, NewsletterJoinParams, NewsletterJoinRequest, NewsletterParams, NewsletterRequest, NewsletterResponse } from "../model/newsletter.model";
...
export class NewsletterController {
   ...
   * @throws ResponseError if member ID not found
   */
  public static async unsubscribe(req: express.Request, res: express.Response, next: express.NextFunction): Promise<void> {
    try {
      // assert request
      const request: NewsletterJoinParams = req.query as NewsletterJoinParams;

      // call service
      const response: NewsletterResponse = await NewsletterService.unsubscribe(request);

      // return response
      res.status(200).json({ status: "Success", code: 200, data: response, message: "Unsubscribe successfully" });
    } catch (error: any) {
      next(error);
    }
  }
  ...
  public static async adminGetAll(req: UserRequest, res: express.Response, next: express.NextFunction): Promise<void> {
    try {
      ...
      // call service
      const response: NewsletterResponse[] = await NewsletterService.adminGetAll(user, filters);
  ...
  public static async adminGetDetail(req: UserRequest, res: express.Response, next: express.NextFunction): Promise<void> {
    try {
      ...
      // call service
      const response: NewsletterResponse = await NewsletterService.adminGetDetail(params);

      // return response
      res.status(200).json({ status: "Success", code: 200, data: response, message: "Get newsletter successfully" });
    } catch (error: any) {
      next(error);
    }
  }
  ...
  public static async adminCreate(req: UserRequest, res: express.Response, next: express.NextFunction): Promise<void> {
    try {
      ...
      // call service
      const response: NewsletterResponse = await NewsletterService.adminCreate(user, request, file);

      // return response
      res.status(200).json({ status: "Success", code: 200, data: response, message: "Create newsletter successfully" });
    } catch (error: any) {
      // clean file
  ...
  public static async adminDelete(req: UserRequest, res: express.Response, next: express.NextFunction): Promise<void> {
    try {
      ...
      // call service
      const response: NewsletterResponse = await NewsletterService.adminDelete(params);

      // return response
      res.status(200).json({ status: "Success", code: 200, data: response, message: "Delete newsletter successfully" });
    } catch (error: any) {
      next(error);
    }
  }
  ...
  public static async adminEditPreview(req: UserRequest, res: express.Response, next: express.NextFunction): Promise<void> {
    try {
      ...
      // call service
      const response: NewsletterResponse = await NewsletterService.adminEditPreview(params);

      // return response
      res.status(200).json({ status: "Success", code: 200, data: response, message: "Get newsletter preview successfully" });
    } catch (error: any) {
      next(error);
    }
  }
  ...
  public static async adminUpdate(req: UserRequest, res: express.Response, next: express.NextFunction): Promise<void> {
    try {
      ...
      // call service
      const response: NewsletterResponse = await NewsletterService.adminUpdate(user, file, params, request);

      // return response
      res.status(200).json({ status: "Success", code: 200, data: response, message: "Update newsletter successfully" });
    } catch (error: any) {
      next(error);
    }
  }
